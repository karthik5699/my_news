...
function makeCorsRequest(){
	...
	xhr.onload = function(){
		...
		for(var i=0;i<marticles.length;i++){
			...
			$('#text-holder').append('<img src="'+article.urlToImage+'" class="img-fluid col-md-6">');
			$('#text-holder').append('<p class="col-md-12">'+article.description+'</p>');
		};
	}
