...
function makeCorsRequest(){
	var xhr = createCORSRequest('GET',"https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=05a33d3d62c74c5884c50c024a3480cf");
	xhr.onload = function(){
		var data = xhr.responseText;
		json_data = JSON.parse(data);
		technology_articles = json_data.articles;

		for(var i=0;i<technology_articles.length;i++){
			var article = technology_articles[i];
