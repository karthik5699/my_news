...
function makeCorsRequest(){
	var xhr = createCORSRequest('GET',"https://newsapi.org/v2/top-headlines?sources=espn&apiKey=05a33d3d62c74c5884c50c024a3480cf");
	xhr.onload = function(){
		var data = xhr.responseText;
		json_data = JSON.parse(data);
		sports_articles = json_data.articles;

		for(var i=0;i<sports_articles.length;i++){
			var article = sports_articles[i];
